...
![Latest tag from master branch](https://github.com/wqyjh/socks5-server/workflows/Latest%20tag%20from%20master%20branch/badge.svg)
![Release tag](https://github.com/wqyjh/socks5-server/workflows/Release%20tag/badge.svg)
...
- Run docker container using default container port 1080 and expose it to world using host port 1080, with auth creds
    ...
    ```docker run -d --name socks5 -p 1080:1080 -e PROXY_USER=<PROXY_USER> -e PROXY_PASSWORD=<PROXY_PASSWORD>  wqyjh/go-socks5-proxy```
...
- Run docker container using specifit container port and expose it to host port 1090, without auth creds
    ...
    ```docker run -d --name socks5 -p 1090:9090 -e PROXY_PORT=9090 wqyjh/go-socks5-proxy```
...
See also the list of [contributors](https://github.com/wqyjh/socks5-server/graphs/contributors) who participated in this project.
